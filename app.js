...
const db = async () => {
    try {
        const conn = await mongoose.connect('mongodb+srv://admin:admin@dhaanishcluster.aw4a6lo.mongodb.net/autorizz?retryWrites=true&w=majority', {
            useNewUrlParser: true,
            useUnifiedTopology: true,
            useFindAndModify: false
        });
// const uri=
// "mongodb+srv://admin:admin@dhaanishcluster.aw4a6lo.mongodb.net/autorizz?retryWrites=true&w=majority";
// const client= await new MongoClient(uri);
        // console.log("MongoDB connected",client);

    } catch (err) {
        console.log("MongoDB Error : Failed to connect");
        console.log("Errosssss",err);
        process.exit(1);
    }
}
